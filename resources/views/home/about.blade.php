...
<!-- breadcrumb-area -->
<section class="breadcrumb-area tg-motion-effects breadcrumb-bg" data-background="uploads/img/bg/breadcrumb_bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
...
<!-- choose-area -->
<section class="choose-area choose-area-two choose-bg" data-background="uploads/img/bg/choose_bg.jpg">
    <div class="container">
        <div class="row">
            <div class="col-lg-12">
                <div class="section-title text-center mb-50">
                    ...
                    <div class="title-shape" data-background="uploads/img/images/title_shape.png"></div>
                </div>
            </div>
        </div>
...
<!-- team-area -->
<section class="team-area team-bg" data-background="uploads/img/bg/team_bg.jpg">
                ...
                <div class="team-item-wrap">
                    <div class="row justify-content-center">
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <img src="uploads/img/team/team_img01.jpg" alt="">
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <img src="uploads/img/team/team_img02.jpg" alt="">
                                    <a href="team-details.html" class="link-btn"><i class="fas fa-plus"></i></a>
                                </div>
                                <div class="team-content">
                                    <div class="line" data-background="uploads/img/images/line.png"></div>
                        ...
                        <div class="col-lg-4 col-md-6 col-sm-8">
                            <div class="team-item">
                                <div class="team-thumb">
                                    <img src="uploads/img/team/team_img03.jpg" alt="">
                                    <a href="team-details.html" class="link-btn"><i class="fas fa-plus"></i></a>
                                </div>
                                <div class="team-content">
                                    <div class="line" data-background="uploads/img/images/line.png"></div>
...
<!-- faq-area -->
<section class="faq-area tg-motion-effects faq-bg" data-background="uploads/img/bg/faq_bg.jpg">
    <div class="container">
    ...
    <div class="faq-shape-wrap">
        <img src="uploads/img/images/faq_shape01.png" alt="" class="tg-motion-effects3">
        <img src="uploads/img/images/faq_shape02.png" alt="" class="tg-motion-effects2">
    </div>
</section>
<!-- faq-area-end -->
